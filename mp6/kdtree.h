...
class KDTree
{
    ...
    private:
         ...
         */
         void build_sub_tree(int left, int right, int d);
         void quick_nth_element(int left, int right, int mid, int d);
         int partition(int left, int right, int pivot, int d);
         void swap(int left, int right);
         Point<Dim> nearest_neighbor(const Point<Dim> &query, const Point<Dim> &candidate, int left, int right, int d) const;
};
